...
const styles = {
  ...
  menuBtn: { position: "fixed", top: "max(70px, env(safe-area-inset-top, 0px) + 54px)", left: 16, zIndex: 100, background: "rgba(0,0,0,0.6)", backdropFilter: "blur(10px)", border: "1px solid rgba(200,160,80,0.45)", borderRadius: 30, padding: "14px 22px", color: "#d4a84b", fontSize: 24, cursor: "pointer", fontFamily: "inherit", transition: "all 0.3s", boxShadow: "0 2px 12px rgba(0,0,0,0.4)" },
